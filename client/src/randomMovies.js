let randomMovies = [
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTkxMjYyNzgwMl5BMl5BanBnXkFtZTgwMTE3MjYyMTE@._V1_SX300.jpg'],
		name: 'Ghostbusters',
		year: 1984,
		rating: 'PG-13',
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTQ5ODI5NTMzN15BMl5BanBnXkFtZTcwNzY4MTYxMg@@._V1_SX300.jpg'],
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTI5Mjg1MzM4NF5BMl5BanBnXkFtZTcwNTAyNzUzMw@@._V1_SX300.jpg'],
		name: 'Rambo',
		year: 2008,
		rating: 'R',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_SX300.jpg'],
	...
	},
	{
		...
		rating: 'PG-13',
		plot:
			'The presidencies of Kennedy, and other historical events unfold through the perspective of an Alabama man with an IQ of 75, whose only desire is to be reunited with his childhood sweetheart.'
	},
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_SX300.jpg'],
		name: 'Inception',
		year: 1990,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTU0NzY0MTY5OF5BMl5BanBnXkFtZTcwODY3MDEwMg@@._V1_SX300.jpg'],
		name: 'Seven Pounds',
		year: 2008,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTUxMzQyNjA5MF5BMl5BanBnXkFtZTYwOTU2NTY3._V1_SX300.jpg'],
		name: 'The Green Mile',
		year: 1999,
		rating: 'R',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTI1MTY2OTIxNV5BMl5BanBnXkFtZTYwNjQ4NjY3._V1_SX300.jpg'],
		name: 'The Departed',
		year: 2006,
		rating: 'R',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMjA4NDI0MTIxNF5BMl5BanBnXkFtZTYwNTM0MzY2._V1_SX300.jpg'],
		name: 'The Prestige',
		year: 2006,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMjIyNTQ5NjQ1OV5BMl5BanBnXkFtZTcwODg1MDU4OA@@._V1_SX300.jpg'],
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BNDM2MzMwMzcxNF5BMl5BanBnXkFtZTcwNTczMDk3OA@@._V1_SX300.jpg'],
		name: 'The Hunt',
		year: 2013,
		rating: 'R',
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTgxOTY4Mjc0MF5BMl5BanBnXkFtZTcwNTA4MDQyMw@@._V1_SX300.jpg'],
		name: 'Toy Story 3',
		year: 2010,
		rating: 'G',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTM4NzQ0OTYyOF5BMl5BanBnXkFtZTcwMDkyNjQyMg@@._V1_SX300.jpg'],
		name: 'Taken',
		year: 2009,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTAwNDEyODU1MjheQTJeQWpwZ15BbWU2MDc3NDQwNw@@._V1_.jpg'],
		name: 'Into the Wild',
		year: 2007,
		rating: 'PG-13',
		plot:
			'After graduating from Emory University, top student and athlete Christopher McCandless abandons his possessions to live in the wilderness.'
	},
	{
		pics: [
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTY1NTI0ODUyOF5BMl5BanBnXkFtZTgwNTEyNjQ0MDE@._V1_.jpg'],
		name: 'Monsters Inc.',
		year: 2001,
		rating: 'PG',
		plot:
	...
	},
	{
		...
		rating: 'R',
		plot:
			'In order to foil a terrorist plot, an FBI agent undergoes facial transplant surgery and assumes the identity of a criminal mastermind.'
	},
	{
		pics: [
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BODgwMjM2ODE4M15BMl5BanBnXkFtZTcwMTU2MDcyMw@@._V1_.jpg'],
		name: 'Date Night',
		year: 2010,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTc0NDQzNTA2Ml5BMl5BanBnXkFtZTcwNzI2OTQzMw@@._V1_.jpg'],
		name: 'The Other Guys',
		year: 2010,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTY0NjI3MzM2Nl5BMl5BanBnXkFtZTcwNDgxNjA5Nw@@._V1_.jpg'],
		name: 'The Campaign',
		year: 2012,
		rating: 'PG-13',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BNTg2OTY2ODg5OF5BMl5BanBnXkFtZTcwODM5MTYxOA@@._V1_.jpg'],
		name: 'Life of Pi',
		year: 2012,
		rating: 'PG',
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTA2MDU0MjM0MzReQTJeQWpwZ15BbWU3MDYwNzgwNzE@._V1_.jpg'],
		name: 'Mamma Mia!',
		year: 2008,
		rating: 'PG',
		plot:
	...
	{
		pics: ['https://m.media-amazon.com/images/M/MV5BMTg4MzMzMTY0OF5BMl5BanBnXkFtZTYwNzM3MTg2._V1_.jpg'],
		name: 'Scooby-Doo',
		year: 2002,
		rating: 'PG',
		plot:
